/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config .types-worker-wrangler.jsonc` (hash: eba5a9d08b8e278fda6ff878a58f784a)
// Runtime types generated with workerd@1.20260603.1 2026-05-13 nodejs_compat
interface __BaseEnv_Env {
	ECHO: DurableObjectNamespace<import("./src/lib/server/index").EchoDO>;
	VOICED_AGENT: DurableObjectNamespace<import("./src/lib/server/index").VoicedAgent>;
	BOT_WORKFLOW: Workflow<Parameters<import("./src/lib/server/index").BotWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/lib/server/index");
		durableNamespaces: "EchoDO" | "VoicedAgent";
	}
